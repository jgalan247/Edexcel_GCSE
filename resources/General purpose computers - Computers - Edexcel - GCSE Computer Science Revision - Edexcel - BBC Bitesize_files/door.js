    ...
    if (window.DotMetricsInitScript == undefined) {
        ...
        function start(hasConsent){
            ...
            var doorUrl = 'http%3a%2f%2fuk-script.dotmetrics.net%2fdoor.js%3fd%3dwww.bbc.co.uk%26t%3dbitesize';
            ...
            if(!hitDone){
                ...
                var imgUrl = 'https://uk-script.dotmetrics.net/hit.gif?id=11818&url=' + pageUrl + '&dom=' + domain + '&r=' + rand + '&pvs=' + pvs + '&ecid=' + ecid + dcOpt + '&c=' + hasConsent + '&tzOffset=' + tzOffset + '&doorUrl=' + doorUrl + '&dfph=' + domainFph+'&ver=355';
                if(sf2!=null){imgUrl+='&sf2='+sf2;}
                var im=new Image;
                im.src = imgUrl;
                im.onload = function (){im.onload=null};

                var panelImgUrl = 'https://rm-script.dotmetrics.net/hit.gif?id=11818&url=' + pageUrl + '&dom=' + domain + '&r=' + rand + '&pvs=' + pvs + '&pvid=' + ecid + '&c=' + hasConsent + '&tzOffset=' + tzOffset;
                        ...
                        window.DotMetricsSettings =
                            {
                                ...
                                ScriptUrl:  'https://uk-script.dotmetrics.net/Scripts/script.js?v=355',
                                ScriptDebugUrl:  'https://download.dotmetrics.net/Script/script.debug.js?v=3e1c0f0a-93a9-44fc-9112-02fa7d28378a',
                                NCSScriptUrl: 'https://uk-script.dotmetrics.net/Scripts/ncs-script.js?v=355',
                                NCSScriptDebugUrl: 'https://download.dotmetrics.net/Script/ncs-script.debug.js?v=7d68b8d4-8e7a-44d2-9924-64ef1888ce18',
                                AdexConfigUrl: 'https://script.api/DotMetrics.Script.Adex/adexConfig.js?v=355&id=11818',
                                SiteSectionId: 11818,
                                SiteId: 1383,
    ...
    function getDomainCookie(hasConsent){
        var ndc='7b028d92-acda-44c2-a80c-ebc33b41d300';
        var dcChanged=false;
